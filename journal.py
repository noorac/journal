...
#TODO: Maybe this is needed for creating an entry?
# def create_entry():
#     sc.clear()
#     draw_title()
#     sc.refresh()
...
#TODO: this needs to be checked later or something, might need this to create new entry
...
# TODO: check over the block below, might be useful, but doubt it
